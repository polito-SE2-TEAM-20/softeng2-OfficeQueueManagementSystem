    ...
    return (
        <Container fluid style={{ minHeight: "100vh", backgroundColor: "#31A861" }}>
            ...
            <Row style={{ marginTop: "100px" }}>
                <Col className="button" onClick={() => onClickWrapper(0)}>
                    <Row>
                ...
                <Col className="button" onClick={() => onClickWrapper(1)}>
                    <Row>
                ...
                <Col className="button" onClick={() => onClickWrapper(2)}>
                    <Row>
            ...
            <Row>
                <Col className="button" onClick={() => onClickWrapper(3)}>
                    <Row>
                ...
                <Col className="button" onClick={() => onClickWrapper(4)}>
                    <Row>
                ...
                <Col className="button" onClick={() => onClickWrapper(5)}>
                    <Row>
